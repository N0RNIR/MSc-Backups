    ...
    def residue_bonds(self, mutant, model):
        ...
        for mutant in os.listdir(self.mutant_path):
            if mutant .endswith('.pdb'):
                ...
                data_file = open('/home/rotan/Desktop/Objective2/Obj.P2_output/' + str(mutant.split('.')[0].replace(':', '_')) + '_contacts.txt', 'w')
                data_file.write(tabulate(table_dict, headers="keys"))
                data_file.close()
                
                
    
    def foldx_stability(self, pdb_path):
        self.pdb_path = pdb_path
        os.chdir(self.pdb_path)
        for file in os.listdir(self.pdb_path):
                if file.endswith('.pdb'):
                    foldx_stability = '/home/rotan/Desktop/FoldX/foldx --command=Stability  --pdb=' + file  + ' --output-dir=/home/rotan/Desktop/Objective2/Obj2.P2_output' 
                    os.system(foldx_stability)
                    

p = MutantAnalysis()
p.residue_bonds('/home/rotan/Desktop/Masters/mutant_pdbs2', '/home/rotan/Desktop/210814_S_4_mer_Model.pdb')
